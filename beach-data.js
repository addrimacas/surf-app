  ...
  'España': {
    'Galicia': {
      ...
      'Rías Baixas': [
        ...
        { nombre:'Samil',        lat:42.2074, lon:-8.7772, orient:252, tol:35, swell:'O-SO',  viento:'NE',    hMin:0.5, hMax:2.0, pMin:8,  portIHM:'vigo',       exposicion:0.35 },
        ...
        { nombre:'Foxos',        lat:42.4264, lon:-8.8746, orient:272, tol:45, swell:'O',     viento:'NE-E',  hMin:0.8, hMax:2.5, pMin:9,  portIHM:'vilagarcia', exposicion:0.65 },
      ...
      'Costa de Barbanza': [
        ...
        { nombre:'Furnas',       lat:42.6396, lon:-9.0391, orient:255, tol:45, swell:'O-SO',  viento:'NE',    hMin:0.8, hMax:2.5, pMin:9,  portIHM:'portosin',   exposicion:0.65 },
        { nombre:'Río Sieira',   lat:42.6469, lon:-9.0364, orient:255, tol:45, swell:'O-SO',  viento:'NE',    hMin:0.8, hMax:2.5, pMin:9,  portIHM:'portosin',   exposicion:0.65 },
        { nombre:'Queiruga',     lat:42.6762, lon:-9.0309, orient:268, tol:45, swell:'O',     viento:'NE',    hMin:0.8, hMax:3.0, pMin:10, portIHM:'portosin',   exposicion:0.70 },
      ...
      'Costa da Morte': [
        ...
        { nombre:'Traba',        lat:43.1936, lon:-9.0409, orient:272, tol:45, swell:'O',     viento:'NE-SE', hMin:0.8, hMax:2.5, pMin:9,  portIHM:'camarinas',  exposicion:0.80 },
      ...
      'Costa Coruñesa': [
        ...
        { nombre:'Valcovo',       lat:43.3160, lon:-8.5331, orient:314, tol:45, swell:'NO-O',  viento:'SE-S',  hMin:0.7, hMax:2.0, pMin:9,  portIHM:'coruna',     exposicion:0.60 },
        { nombre:'Repibelo',      lat:43.3226, lon:-8.5215, orient:314, tol:45, swell:'NO-O',  viento:'SE-S',  hMin:0.7, hMax:2.0, pMin:9,  portIHM:'coruna',     exposicion:0.58 },
        { nombre:'Sabón',         lat:43.3278, lon:-8.5098, orient:314, tol:45, swell:'NO-O',  viento:'SE-S',  hMin:0.7, hMax:2.0, pMin:9,  portIHM:'coruna',     exposicion:0.55 },
        { nombre:'Orzán',         lat:43.3739, lon:-8.4033, orient:306, tol:50, swell:'NO-O',  viento:'SE-S',  hMin:0.8, hMax:2.5, pMin:9,  portIHM:'coruna',     exposicion:0.50 },
        { nombre:'Riazor',        lat:43.3683, lon:-8.4089, orient:315, tol:50, swell:'NO-N',  viento:'SE-S',  hMin:0.8, hMax:2.5, pMin:9,  portIHM:'coruna',     exposicion:0.45 },
        { nombre:'Matadero',      lat:43.3755, lon:-8.4036, orient:305, tol:45, swell:'NO-O',  viento:'SE-S',  hMin:0.7, hMax:2.0, pMin:9,  portIHM:'coruna',     exposicion:0.42 },
        { nombre:'Santa Cristina',lat:43.3393, lon:-8.3769, orient:355, tol:40, swell:'N-NO',  viento:'SO-S',  hMin:0.6, hMax:2.0, pMin:8,  portIHM:'sada',       exposicion:0.28 },
      ...
      'Ferrolterra': [
        ...
        { nombre:'Vilarrube',  lat:43.6422, lon:-8.0718, orient:338, tol:45, swell:'N-NO',  viento:'SO-S',  hMin:0.8, hMax:2.5, pMin:9,  portIHM:'cedeira', exposicion:0.70 },
      ],
